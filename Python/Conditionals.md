...
- [Control Flow, elif, and else](https://cs50.harvard.edu/python/notes/1/#control-flow-elif-and-else)
- [or](https://cs50.harvard.edu/python/notes/1/#or)
- [and](https://cs50.harvard.edu/python/notes/1/#and)
- [Modulo](https://cs50.harvard.edu/python/notes/1/#modulo)
- [Creating Our Own Parity Function](https://cs50.harvard.edu/python/notes/1/#creating-our-own-parity-function)
- [Pythonic](https://cs50.harvard.edu/python/notes/1/#pythonic)
- [`match`](https://cs50.harvard.edu/python/notes/1/#match)
- [Summing Up](https://cs50.harvard.edu/python/notes/1/#summing-up)
